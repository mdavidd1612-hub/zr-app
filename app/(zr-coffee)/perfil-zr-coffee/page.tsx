...
// Perfil del rol ZR Coffee (migración 095): Cecilia cambia aquí de vuelta a
// Administración -- mismo componente genérico (CambiarRol) que ya usa Erika
// Hidalgo para admin/vendedor, sin nada específico de ZR Coffee.
export default function PerfilZRCoffee() {
