...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-zr-background min-h-dvh">
      ...
      {/* Content - Inspired by ZR Mecademy official site */}
      <div className="flex-1 overflow-y-auto px-5 pb-24">
        <div className="space-y-8 pt-6">
          {/* Greeting - Clean and professional */}
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full group bg-gradient-to-r from-zr-blue-deep to-zr-blue text-white rounded-lg p-5 text-left hover:shadow-md transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="bg-zr-surface border border-zr-border text-zr-text rounded-lg p-4 text-center hover:border-zr-blue/50 hover:bg-zr-surface/80 transition-all duration-200"
            >
          ...
          <button
            ...
            className="w-full bg-zr-surface border border-zr-border text-zr-text rounded-lg p-4 text-left hover:border-zr-blue/50 hover:bg-zr-surface/80 transition-all duration-200"
          >
          ...
          {/* Stats - Section with number prefix like website */}
